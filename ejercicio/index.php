...
<p>Los profesores que "han demostrado una actividad docente sostenida, realizándola en forma autónoma y creativa, con pleno dominio de su especialidad, dando a conocer su experiencia en textos de uso docente", son:</p>
<ol>
<?php
for ($e = 0; $e < $all; $e++) {
  if((($datos[$e]['Rango']) == "Profesor Asociado de Docencia") ){
    echo '<li>'.strstr($datos[$e]["Nombres"], ' ', true).' '.$datos[$e]["Apellidos"].' ('.$datos[$e]["Rango"].') ('.$datos[$e]["Horas"]. ' Hrs.)</li>';
  }
};?>
</ol>

<p>Según esto los académicos dedican <strong> <?php print_r($horas/$all); ;?></strong> horas en promedio a actividades en la FAU.</p>
...
<p>Si resuelve todo antes de que termine la clase: intente agregar una página de detalle, donde se despliegue más información sobre cada académico. /no grax</p>
